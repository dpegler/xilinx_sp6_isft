...
#define DMA_RX_IRPT_INTR XPAR_INTERRUPT_CNTLR_DDR3_SDRAM_SDMA2_RX_INTOUT_INTR
#define DMA_TX_IRPT_INTR XPAR_INTERRUPT_CNTLR_DDR3_SDRAM_SDMA2_TX_INTOUT_INTR
#endif
